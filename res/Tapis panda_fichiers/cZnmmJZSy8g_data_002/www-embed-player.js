...
Y),fi="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),gi={},hi=(gi.mver="MEASUREMENT_VERSION_",gi.pis="PLAYER_INITIALIZED_STATE_",gi.yt_pt="LATENCY_PLAYER_",gi.pa="LATENCY_ACTION_",gi.yt_vst="VIDEO_STREAM_TYPE_",gi),ii="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt upg_player_vis yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts tds plt rce ytu_pvis".split(" ");
...
;var li={vc:!0};
function mi(){Oh().yt_lt="hot_bg";if(ji()){var a="hot_bg";var b=ki();if(b.gelInfos)b.gelInfos.info_yt_lt=!0;else{var c={};b.gelInfos=(c.info_yt_lt=!0,c)}if("yt_lt"in ei){b=ei.yt_lt;0<=Ja(fi,b)&&(a=!!a);"yt_lt"in hi&&"string"===typeof a&&(a=hi.yt_lt+a.toUpperCase());b=b.split(".");for(var d=c={},e=0;e<b.length-1;e++){var f=b[e];d[f]={};d=d[f]}d[b[b.length-1]]=a;a=Sh({},c)}else 0<=Ja(ii,"yt_lt")||(a=new di("Unknown label logged with GEL CSI"),a.params={label:"yt_lt"},fe(a)),a=void 0;a&&ji()&&(b=Yh(),
...
function ni(){if(!ji()){var a=Mh(void 0),b=Oh(),c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&z(a[f])){var d=f.slice(1);if(d in li){var e=La(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=O("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:O("TIMING_ACTION",void 0)};d=mi.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+y("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Lh();Nh()&&"youtube"==e&&(mi(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=U();h={};e=[];for(var k in a)"_"!=
